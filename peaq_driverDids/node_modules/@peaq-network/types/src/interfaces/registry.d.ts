...
declare module '@polkadot/types/types/registry' {
    interface InterfaceTypes {
        ...
        ParachainStakingRewardRateRewardRateInfo: ParachainStakingRewardRateRewardRateInfo;
        ...
        PeaqDevRuntimeOpaqueSessionKeys: PeaqDevRuntimeOpaqueSessionKeys;
        PeaqDevRuntimeOriginCaller: PeaqDevRuntimeOriginCaller;
        PeaqDevRuntimeRuntime: PeaqDevRuntimeRuntime;
        PeaqPalletDidCall: PeaqPalletDidCall;
        PeaqPalletDidError: PeaqPalletDidError;
        PeaqPalletDidEvent: PeaqPalletDidEvent;
        PeaqPalletDidStructsAttribute: PeaqPalletDidStructsAttribute;
        PeaqPalletMorCall: PeaqPalletMorCall;
        PeaqPalletMorError: PeaqPalletMorError;
        PeaqPalletMorEvent: PeaqPalletMorEvent;
        PeaqPalletRbacCall: PeaqPalletRbacCall;
        PeaqPalletRbacError: PeaqPalletRbacError;
        PeaqPalletRbacEvent: PeaqPalletRbacEvent;
        PeaqPalletRbacStructsEntity: PeaqPalletRbacStructsEntity;
        PeaqPalletRbacStructsPermission2Role: PeaqPalletRbacStructsPermission2Role;
        PeaqPalletRbacStructsRole2Group: PeaqPalletRbacStructsRole2Group;
        PeaqPalletRbacStructsRole2User: PeaqPalletRbacStructsRole2User;
        PeaqPalletRbacStructsUser2Group: PeaqPalletRbacStructsUser2Group;
        PeaqPalletStorageCall: PeaqPalletStorageCall;
        PeaqPalletStorageError: PeaqPalletStorageError;
        PeaqPalletStorageEvent: PeaqPalletStorageEvent;
        PeaqPalletTransactionCall: PeaqPalletTransactionCall;
        PeaqPalletTransactionError: PeaqPalletTransactionError;
        PeaqPalletTransactionEvent: PeaqPalletTransactionEvent;
        PeaqPalletTransactionStructsDeliveredInfo: PeaqPalletTransactionStructsDeliveredInfo;
        PeaqPalletTransactionStructsTimepoint: PeaqPalletTransactionStructsTimepoint;
        PeaqPrimitivesXcmCurrencyCurrencyId: PeaqPrimitivesXcmCurrencyCurrencyId;
        PeaqPrimitivesXcmCurrencyTokenSymbol: PeaqPrimitivesXcmCurrencyTokenSymbol;
