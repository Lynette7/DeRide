...
declare module '@polkadot/api-base/types/storage' {
    interface AugmentedQueries<ApiType extends ApiTypes> {
        ...
        tokens: {
             ...
             * balances.
             **/
            accounts: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: PeaqPrimitivesXcmCurrencyCurrencyId | {
                Token: any;
            } | {
                Erc20: any;
            } | string | Uint8Array) => Observable<OrmlTokensAccountData>, [AccountId32, PeaqPrimitivesXcmCurrencyCurrencyId]> & QueryableStorageEntry<ApiType, [AccountId32, PeaqPrimitivesXcmCurrencyCurrencyId]>;
            /**
             * Any liquidity locks of a token type under an account.
             * NOTE: Should only be accessed when setting, changing and freeing a lock.
             **/
            locks: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: PeaqPrimitivesXcmCurrencyCurrencyId | {
                Token: any;
            } | {
                Erc20: any;
            } | string | Uint8Array) => Observable<Vec<OrmlTokensBalanceLock>>, [AccountId32, PeaqPrimitivesXcmCurrencyCurrencyId]> & QueryableStorageEntry<ApiType, [AccountId32, PeaqPrimitivesXcmCurrencyCurrencyId]>;
            /**
             * Named reserves on some account balances.
             **/
            reserves: AugmentedQuery<ApiType, (arg1: AccountId32 | string | Uint8Array, arg2: PeaqPrimitivesXcmCurrencyCurrencyId | {
                Token: any;
            } | {
                Erc20: any;
            } | string | Uint8Array) => Observable<Vec<OrmlTokensReserveData>>, [AccountId32, PeaqPrimitivesXcmCurrencyCurrencyId]> & QueryableStorageEntry<ApiType, [AccountId32, PeaqPrimitivesXcmCurrencyCurrencyId]>;
            /**
             * The total issuance of a token type.
             **/
            totalIssuance: AugmentedQuery<ApiType, (arg: PeaqPrimitivesXcmCurrencyCurrencyId | {
                Token: any;
            } | {
                Erc20: any;
            } | string | Uint8Array) => Observable<u128>, [PeaqPrimitivesXcmCurrencyCurrencyId]> & QueryableStorageEntry<ApiType, [PeaqPrimitivesXcmCurrencyCurrencyId]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
